      ...
      <div className="row y-gap-10 items-center justify-between">
        <div className="col-auto">
          <div className="form-checkbox d-flex items-center">
            ...
            <div className="text-15 ml-10">Aalborg</div>
          </div>
        </div>
        {/* End .col */}
        <div className="col-auto">
      ...
      <div className="row y-gap-10 items-center justify-between">
        <div className="col-auto">
          <div className="form-checkbox d-flex items-center">
            ...
            <div className="text-15 ml-10">Aarhus</div>
          </div>
        </div>
        {/* End .col */}
        <div className="col-auto">
      ...
      <div className="row y-gap-10 items-center justify-between">
        <div className="col-auto">
          <div className="form-checkbox d-flex items-center">
            ...
            <div className="text-15 ml-10">Abu Dhabi</div>
          </div>
        </div>
        {/* End .col */}
        <div className="col-auto">
      ...
      <div className="row y-gap-10 items-center justify-between">
        <div className="col-auto">
          <div className="form-checkbox d-flex items-center">
            ...
            <div className="text-15 ml-10">Agadir</div>
          </div>
        </div>
        {/* End .col */}
        <div className="col-auto">
